      ...
      if(data.configprops.agg_proactiverec_enabled){
        ...
        if(data.configprops.agg_proactiverec_method=="remedial"){
          ...
          if(recommended_activities.length > max_rec_n) {
            var good_recommendations = false;
            //while(!good_recommendations){
              var top_rec_list_first_index = recommended_activities.length/2 - max_rec_n/2;
              if (top_rec_list_first_index<0){
                top_rec_list_first_index=0;
              }
              ...
              topics_with_recommendations = Object.keys(recommendations_per_topic);
              // if(topics_with_recommendations.length==1){
              //   var target_topic = topics_with_recommendations[0];
              //   if(recommendations_per_topic[target_topic]<=max_remedial_recommendations_per_topic){
              //     good_recommendations = true;
              //   }else{
              //     var recommendations_to_keep = 0;
              //     for(int i=0;i<recommended_activities.length;i++){
              //       if(recommended_activities[i].topic==){
