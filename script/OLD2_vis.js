...
function loadData() {
  ...
  (state.args.dataLive
    ? $call("GET", CONST.uriServer+"GetContentLevels?key=221&usr=" + state.curr.usr + "&grp=" + state.curr.grp + "&sid=" + state.curr.sid + "&cid=" + state.curr.cid + "&mod=all&models=" + (state.args.dataReqOtherLearners ? "-1" : "0") + "&avgtop=" + state.args.dataTopNGrp, null, loadData_cb, true, false)
